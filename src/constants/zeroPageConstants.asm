...
.label ZP_TEXT_LO			    = ZERO_PAGE_ADDRESS + 21
.label ZP_TEXT_HI			    = ZERO_PAGE_ADDRESS + 22
.label ZP_HUD_COLOR_LO	        = ZERO_PAGE_ADDRESS + 23
.label ZP_HUD_COLOR_HI          = ZERO_PAGE_ADDRESS + 24
